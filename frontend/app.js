document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_URL = isLocal ? 'http://localhost:5501/api' : '/api';
    ...
    async function bloglariGetir() {
        ...
        try {
            ...
            kart.addEventListener('click', () => openBlogModal(yazi._id || yazi.id));
    ...
    document.getElementById('btnSorgula').addEventListener('click', async () => {
        ...
        try {
            ...
            if (response.ok) {
                // Hasta bulundu, formu doldur
            document.getElementById('hastaId').value = hasta._id || hasta.id;
